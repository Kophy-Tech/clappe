...
```html
<link rel="stylesheet" to="/node_modules/owl.carousel/dist/assets/owl.carousel.min.css" />
```

```html
<link rel="stylesheet" to="/bower_components/owl.carousel/dist/assets/owl.carousel.min.css" />
```
