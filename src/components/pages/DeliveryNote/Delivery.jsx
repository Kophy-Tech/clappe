...
//   const [allDeliveryNote, setAllDeliveryNote] = React.useState([]);
...
//   }, []);
//   React.useEffect(() => {
//     setAllDeliveryNote(store.DeliveryNote);
//     console.log("store.DeliveryNote", store.DeliveryNote);
//   }, [store]);
              ...
              <Col sm={12} md={6}>
                <div className="mx-5">
                  ...
                  <div className="form-group d-flex justify-content-between mb-3 ">
                    ...
                    //     setAllDeliveryNote(
                    //       searchData(value, "business_name", store.DeliveryNote)
                    //     );
                    //   }}
                    />
                  </div>
                  ...
                  <div className="form-group d-flex mb-3 justify-content-between">
                    ...
                    //     const value = e.target.value;
                    //     setAllDelivery Note(
                    //       searchData(value, "amount", store.Delivery Note)
                    //     );
                    //   }}
                    />
                  </div>
                  ...
                  <div className="form-group d-flex justify-content-between mb-3">
                    <label htmlFor="customer">Delivery Note No:</label>
                    <input
                      type="text"
                      className="form-control w-50"
                    //   onChange={(e) => {
                    //     const value = e.target.value;
                    //     setAllDelivery Note(
                    //       searchData(value, "Delivery Note_number", store.Delivery Note)
                    //     );
                    //   }}
                    />
                  </div>
              ...
              <Col sm={12} md={6}>
                <div className="mx-5">
                  ...
                  <div className="form-group d-flex mb-3 justify-content-between">
                    ...
                    //     const value = e.target.value;
                    //     setAllDeliveryNote(
                    //       searchData(value, "address", store.DeliveryNote)
                    //     );
                    //   }}
                    />
                  </div>
                  ...
                  <div className="form-group d-flex justify-content-between mb-3">
                    ...
                    //     } else {
                    //       setAllDeliveryNote(
                    //         searchData(value, "status", store.DeliveryNote)
                    //       );
                    //     }
                    //   }}
                    >
        ...
        <div className="text-center  mb-5">
          ...
          <Row>
            <div className="d-flex flex-row justify-content-between">
              <div className>
                <Link to="/newdeliverynote" className="mybtn">
