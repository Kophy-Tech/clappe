              ...
              <Col sm={12} md={6}>
                <div className="mx-5">
                  ...
                  <div className="form-group d-flex justify-content-between mb-3 ">
                    ...
                    //     setAllQuotes(
                    //       searchData(value, "business_name", store.Quotes)
                    //     );
                    //   }}
                    />
                  </div>
                  ...
                  <div className="form-group d-flex mb-3 justify-content-between">
                    ...
                    //     const value = e.target.value;
                    //     setAllQuotes(
                    //       searchData(value, "amount", store.Quotes)
                    //     );
                    //   }}
                    />
                  </div>
                  {/* Quote Input Field  */}
                  <div className="form-group d-flex justify-content-between mb-3">
                    <label htmlFor="customer">Quote No:</label>
                    <input
                      type="text"
                      className="form-control w-50"
                    //   onChange={(e) => {
                    //     const value = e.target.value;
                    //     setAllQuotes(
                    //       searchData(value, "Quote_number", store.Quotes)
                    //     );
                    //   }}
                    />
                  </div>
              ...
              <Col sm={12} md={6}>
                <div className="mx-5">
                  ...
                  <div className="form-group d-flex mb-3 justify-content-between">
                    ...
                    //     const value = e.target.value;
                    //     setAllQuotes(
                    //       searchData(value, "address", store.Quotes)
                    //     );
                    //   }}
                    />
                  </div>
                  ...
                  <div className="form-group d-flex justify-content-between mb-3">
                    ...
                    //     } else {
                    //       setAllQuotes(
                    //         searchData(value, "status", store.Quotes)
                    //       );
                    //     }
                    //   }}
                    >
        ...
        <div className="text-center  mb-5">
          ...
          <Row>
            <div className="d-flex flex-row justify-content-between">
              <div className>
                <Link to="/newquotes" className="mybtn">
                  [+] Add New Quote 
                </Link>
              </div>
